...
global.dfail = (type, m, conn) => {
  const msg = {
    rowner: '*[ 🗿 ]هذا الامر مخصص للمطور فقط*',
    owner: '*[ 🗿 ]هذا الامر مخصص للمطور فقط*',
    mods: '*[ 🗿 ]هذا الامر مخصص للمطور فقط.*',
    premium: '*[ 🗿 ]هذا الامر مخصص للمطور.*',
    group: '*[ 🗿 ]هذا الامر مخصص للقروبات فقط*',
    private: '*[ 🗿 ] هذا الامر يستعمل في الخاص فقط*',
    admin: '*[ 🗿 ]هذا الامر مخصص للادمن فقط*',
    botAdmin: '*[ 🗿 ]لاستخدام هذا الامر يجب ان يكون البوت ادمن اولا*',
    unreg: '*[ 🗿 ]يجب عليك التسجيل في البوت لاستخدام الامر*\n\n*[ 💡 ]استخم الامر:* _#تسجيل الاسم.العمر_ *للتسجيل.*',
    restrict: '*[ 🗿 ]هذا الامر تم اغلاقه بواسطة المطور*',
  }[type];
  const aa = {quoted: m, userJid: conn.user.jid};
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '*[ ⚠ ]تحذير', body: '𝑀𝐴𝐾𝐼𝑀𝐴 𝐵𝛩𝑇', thumbnail: imagen1, sourceUrl: 'https://chat.whatsapp.com/IVJKhm24AFoGlgArjdlbzf'}}}}, aa);
